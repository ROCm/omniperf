**************************
Grafana analysis dashboard
**************************

Find setup instructions in :doc:`grafana-setup`.
...
Refer to :ref:`profiling-hw-component-filtering` section for this command.
...
.. figure:: ../../data/analyze/grafana/vl1d-cache-accesses_panel.png
   ...
   The type of requests incoming from the cache frontend, the number of requests
