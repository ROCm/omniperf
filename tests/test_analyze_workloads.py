...
def test_analyze_dispatch_0_MI100():
    with pytest.raises(SystemExit) as e:
        with patch(
            "sys.argv",
            ["rocprofiler-compute", "analyze", "--path", "tests/workloads/dispatch_0/MI100"],
        ):
            rocprof_compute.main()
    assert e.value.code == 0
...
def test_analyze_dispatch_0_MI200():
    with pytest.raises(SystemExit) as e:
        with patch(
            "sys.argv",
            ["rocprofiler-compute", "analyze", "--path", "tests/workloads/dispatch_0/MI200"],
        ):
            rocprof_compute.main()
    assert e.value.code == 0
...
def test_analyze_kernel_MI300X_A1():
    with pytest.raises(SystemExit) as e:
        with patch(
            "sys.argv",
            ["rocprofiler-compute", "analyze", "--path", "tests/workloads/kernel/MI300X_A1"],
        ):
            rocprof_compute.main()
    assert e.value.code == 0
...
def test_analyze_kernel_MI300A_A1():
    with pytest.raises(SystemExit) as e:
        with patch(
            "sys.argv",
            ["rocprofiler-compute", "analyze", "--path", "tests/workloads/kernel/MI300A_A1"],
        ):
            rocprof_compute.main()
    assert e.value.code == 0
...
def test_analyze_dispatch_7_MI100():
    with pytest.raises(SystemExit) as e:
        with patch(
            "sys.argv",
            ["rocprofiler-compute", "analyze", "--path", "tests/workloads/dispatch_7/MI100"],
        ):
            rocprof_compute.main()
...
def test_analyze_dispatch_7_MI200():
    with pytest.raises(SystemExit) as e:
        with patch(
            "sys.argv",
            ["rocprofiler-compute", "analyze", "--path", "tests/workloads/dispatch_7/MI200"],
        ):
            rocprof_compute.main()
    assert e.value.code == 1
...
def test_analyze_dispatch_2_MI100():
    with pytest.raises(SystemExit) as e:
        with patch(
            "sys.argv",
            ["rocprofiler-compute", "analyze", "--path", "tests/workloads/dispatch_2/MI100"],
        ):
            rocprof_compute.main()
    assert e.value.code == 0
...
def test_analyze_dispatch_2_MI200():
    with pytest.raises(SystemExit) as e:
        with patch(
            "sys.argv",
            ["rocprofiler-compute", "analyze", "--path", "tests/workloads/dispatch_2/MI200"],
        ):
            rocprof_compute.main()
    assert e.value.code == 0
...
def test_analyze_ipblocks_TA_MI100():
    with pytest.raises(SystemExit) as e:
        with patch(
            "sys.argv",
            ["rocprofiler-compute", "analyze", "--path", "tests/workloads/ipblocks_TA/MI100"],
        ):
            rocprof_compute.main()
    assert e.value.code == 0
...
def test_analyze_ipblocks_TA_MI200():
    with pytest.raises(SystemExit) as e:
        with patch(
            "sys.argv",
            ["rocprofiler-compute", "analyze", "--path", "tests/workloads/ipblocks_TA/MI200"],
        ):
            rocprof_compute.main()
    assert e.value.code == 0
...
def test_analyze_ipblocks_TD_MI100():
    with pytest.raises(SystemExit) as e:
        with patch(
            "sys.argv",
            ["rocprofiler-compute", "analyze", "--path", "tests/workloads/ipblocks_TD/MI100"],
        ):
            rocprof_compute.main()
    assert e.value.code == 0
...
def test_analyze_ipblocks_TD_MI200():
    with pytest.raises(SystemExit) as e:
        with patch(
            "sys.argv",
            ["rocprofiler-compute", "analyze", "--path", "tests/workloads/ipblocks_TD/MI200"],
        ):
            rocprof_compute.main()
    assert e.value.code == 0
...
def test_analyze_ipblocks_SQ_MI100():
    with pytest.raises(SystemExit) as e:
        with patch(
            "sys.argv",
            ["rocprofiler-compute", "analyze", "--path", "tests/workloads/ipblocks_SQ/MI100"],
        ):
            rocprof_compute.main()
    assert e.value.code == 0
...
def test_analyze_ipblocks_SQ_MI200():
    with pytest.raises(SystemExit) as e:
        with patch(
            "sys.argv",
            ["rocprofiler-compute", "analyze", "--path", "tests/workloads/ipblocks_SQ/MI200"],
        ):
            rocprof_compute.main()
    assert e.value.code == 0
