...
Grafana server for Omniperf
   ...
   * **Grafana analysis dashboard GUI**: The
     :doc:`Grafana dashboard <grafana-analyzer>` retrieves the raw counters
     information from the backend database. It displays the relevant
     performance metrics and visualization.

Omniperf standalone GUI analyzer
   Omniperf provides a :doc:`standalone GUI <standalone-analyzer>` to enable
...
Omniperf supports analysis through both the :doc:`command line <cli>` or a
:doc:`GUI <grafana-gui>`. The following list describes Omniperf's features at a
high level.

* :doc:`Support for AMD Instinct MI300, MI200, and MI100 accelerators <reference/compatible-accelerators>`

* :doc:`Standalone GUI analyzer <standalone-gui>`

* :doc:`GUI analyzer via Grafana and MongoDB <grafana-gui>`
...
* :ref:`Filtering <profiling-filtering>` to reduce profiling time
