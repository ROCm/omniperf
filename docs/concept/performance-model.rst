...
:doc:`<how-to/profile-mode>` for more practical examples and details on how to
use Omniperf to optimize your code.
...
* :mantor-gcn-pdf:`AMD Radeon HD7970 with GCN Architecture (Mike Mantor) <>`

* :mantor-vega10-pdf:`AMD Instinct MI200 ISA Reference Guide (Mike Mantor) <>`
